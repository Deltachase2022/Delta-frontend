...
- Product folders and files structured are updated: [README](https://github.com/creativetimofficial/react/blob/main/README.md)
...
- https://github.com/creativetimofficial/react/issues/86
...
- https://github.com/creativetimofficial/react/issues/85
...
- https://github.com/creativetimofficial/react/issues/75
...
- https://github.com/creativetimofficial/react/issues/67
...
- Solved https://github.com/creativetimofficial/react/issues/52
...
- https://github.com/creativetimofficial/react/issues/46
- https://github.com/creativetimofficial/react/issues/44
- Updated available scripts
- Changed the _.babelrc_ file

### Major style changes

- **src/assets/jss/react/components/headerStyle.jsx**
- **src/assets/jss/react/components/customDropdownStyle.jsx**
...
- Github own repo
  - [https://github.com/creativetimofficial/react/issues/36](https://github.com/creativetimofficial/react/issues/36)
- Github othe repos
...
- `src/assets/jss/react/components/headerStyle.jsx`
- `src/assets/jss/react/components/snackbarContentStyle.jsx`
- `src/assets/jss/react/views/loginPage.jsx`
- `src/assets/jss/react/customCheckboxRadioSwitch.jsx`
- `src/assets/scss/plugins/_plugin-nouislider.scss`
...
- Github
  - [https://github.com/creativetimofficial/react/issues/16](https://github.com/creativetimofficial/react/issues/16)
  - [https://github.com/creativetimofficial/react/issues/25](https://github.com/creativetimofficial/react/issues/25)
  - [https://github.com/creativetimofficial/react/issues/26](https://github.com/creativetimofficial/react/issues/26)
  - [https://github.com/creativetimofficial/react/issues/28](https://github.com/creativetimofficial/react/issues/28)

### Major styling changes

- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/assets/jss/react/components/buttonStyle.jsx`
  - `src/assets/jss/react/components/customInputStyle.jsx`
  - `src/assets/jss/react/components/customDropdownStyle.jsx`
  - `src/assets/jss/react/components/headerLinksStyle.jsx`
  - `src/assets/jss/react/components/headerStyle.jsx`
  - `src/assets/jss/react/views/loginPage.jsx`
...
- `src/assets/jss/react/components/buttonStyle.jsx`, due to the fact that we've droped `src/components/CustomButtons/IconButton.jsx`
- `src/assets/jss/react/components/customInputStyle.jsx`
- `src/assets/jss/react/components/customTabsStyle.jsx`
- `src/assets/jss/react/components/headerLinksStyle.jsx`
...
- Added design from Material Dashboard by Deltachase Team
